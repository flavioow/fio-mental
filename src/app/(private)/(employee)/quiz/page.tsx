    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-start p-8 bg-accent text-foreground">
            <div className="w-full max-w-xl bg-card rounded-lg shadow p-8 mb-4">
                <h2 className="text-2xl font-bold mb-6 text-center bg-accent border border-accent-500 rounded-xl p-2">Saúde Mental e Bem-Estar</h2>
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="font-semibold">Como você avaliaria seu nível atual de estresse no trabalho de 1 a 10?</label>
                        <input name="estresse" type="number" min={1} max={10} className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.estresse} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">O que mais costuma gerar estresse ou ansiedade no seu dia a dia profissional?</label>
                        <textarea name="motivoEstresse" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.motivoEstresse} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Você sente que consegue equilibrar bem trabalho e vida pessoal?</label>
                        <textarea name="equilibrio" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.equilibrio} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Quando enfrenta um problema no trabalho, qual costuma ser sua primeira reação?</label>
                        <textarea name="reacaoProblema" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.reacaoProblema} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Você sente que tem espaço para falar sobre seu bem-estar com colegas ou líderes?</label>
                        <textarea name="espacoBemEstar" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.espacoBemEstar} onChange={handleChange} />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="motivacao" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.motivacao} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">O que mais desmotiva ou atrapalha sua produtividade?</label>
                        <textarea name="desmotivacao" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.desmotivacao} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Em quais momentos do dia você sente que trabalha melhor (manhã, tarde, noite)?</label>
                        <textarea name="melhorHorario" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.melhorHorario} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Você se considera mais focado em tarefas individuais ou colaborativas?</label>
                        <textarea name="foco" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.foco} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">O que poderia aumentar sua satisfação e motivação no ambiente de trabalho?</label>
                        <textarea name="satisfacao" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.satisfacao} onChange={handleChange} />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="pedirAjuda" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.pedirAjuda} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Como você lida com conflitos ou divergências no time?</label>
                        <textarea name="conflitos" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.conflitos} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">O quanto você sente que é ouvido e respeitado nas reuniões ou discussões de equipe?</label>
                        <textarea name="ouvido" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.ouvido} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Qual é o tipo de colega ou líder que mais te ajuda a render melhor?</label>
                        <textarea name="tipoColega" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.tipoColega} onChange={handleChange} />
                    </div>
                    <div>
                        ...
                        <textarea name="ambiente" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.ambiente} onChange={handleChange} />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="habilidades" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.habilidades} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Você sente que tem oportunidades reais de crescimento dentro da empresa?</label>
                        <textarea name="oportunidades" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.oportunidades} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">O que faria você se sentir mais confiante para assumir novas responsabilidades?</label>
                        <textarea name="confianca" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.confianca} onChange={handleChange} />
                    </div>
                    <div>
                        <label className="font-semibold">Em uma palavra, como você definiria sua relação atual com o trabalho?</label>
                        <input name="palavra" type="text" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.palavra} onChange={handleChange} />
                    </div>
                    <div>
                        ...
                        <textarea name="mudanca" className="bg-primary-foreground mt-2 w-full border rounded px-3 py-2" required value={form.mudanca} onChange={handleChange} />
                    </div>
